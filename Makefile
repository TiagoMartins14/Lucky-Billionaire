...
new_round:
	forge script script/StartNewRound.s.sol --rpc-url $$SEPOLIA_RPC_URL --broadcast -vvvv

withdraw_vault:
	forge script script/WithdrawAll.s.sol --rpc-url $$SEPOLIA_RPC_URL --broadcast -vvvv